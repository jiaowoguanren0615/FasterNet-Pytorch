...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'FasterNet training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=8, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='fasternet_t0', type=str, metavar='MODEL',
                        choices=['fasternet_t0', 'fasternet_t1', 'fasternet_t2', 'fasternet_s', 'fasternet_m', 'fasternet_l'],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'FasterNet training and evaluation script', parents=[get_args_parser()])
